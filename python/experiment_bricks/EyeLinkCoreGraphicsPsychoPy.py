...
class EyeLinkCoreGraphicsPsychoPy(pylink.EyeLinkCustomDisplay):
    def __init__(self, tracker, win):
        ...
        # EB (BUSCHLAB): commented because this statement yields a None type, 
        # and the previous definition of width and height are already accurate.
    ...
    def play_beep(self, beepid):
        ...
        if self.enableBeep:
            ...
            # commented by EB (BUSCHLAB) to prevent sound library problems
